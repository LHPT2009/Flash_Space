      ...
      <div className=" container-scroller">
        <div className="main-panel">
          <div className="content-wrapper">
            <div className="row">
              <div className="col-lg-12 grid-margin grid-margin-md-0">
                <div className="card">
                  <div className="card-body">
                    <div className="row icons-list">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-account-location"></i> mdi
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-apple-mobileme "></i> mdi
                        mdi-apple-mobileme
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-arrow-compress"></i> mdi
                        mdi-arrow-compress
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-cloud-outline-off"></i> mdi
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-disk-alert"></i> mdi
                        mdi-disk-alert
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-email-secure"></i> mdi
                        mdi-email-secure
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-fridge-filled"></i> mdi
                        mdi-fridge-filled
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-fridge-filled-top"></i> mdi
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-google-wallet"></i> mdi
                        mdi-google-wallet
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-library-plus"></i> mdi
                        mdi-library-plus
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-nest-thermostat"></i> mdi
                        mdi-nest-thermostat
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-rdio"></i> mdi mdi-radio
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-smoking-off"></i> mdi
                        mdi-smoking-off
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                      ...
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-unfold-less"></i> mdi
                        mdi-unfold-less
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
                        <i className="mdi mdi-unfold-more"></i> mdi
                        mdi-unfold-more
                      </div>
                      <div className="col-sm-6 col-md-4 col-lg-3">
